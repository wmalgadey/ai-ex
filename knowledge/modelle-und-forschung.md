...
LLMs, Quantisierung, Embeddings, Capability-Demos.

## Artikel

- [LLM Daydreaming — gwern.net](llm-daydreaming-gwern.md) — Gwern über zwei fehlende Mechanismen: Frozen Learning und Hintergrundprozesse
- [Don Knuth: "Claude's Cycles"](knuth-claude-cycles.md) — Claude Opus 4.6 löst ein offenes kombinatorisches Problem aus Knuths TAOCP
